 ...
 */
public class TimeSeriesBarDemo3 extends ApplicationFrame {
     ...
     */
    public TimeSeriesBarDemo3(String title) {
        super(title);
        TimeSeries s1 = new TimeSeries("Sunshine Hours", Month.class);
    ...
    public static void main(String[] args) {
        TimeSeriesBarDemo3 demo = new TimeSeriesBarDemo3("Time Series Bar Demo 3");
        demo.pack();
